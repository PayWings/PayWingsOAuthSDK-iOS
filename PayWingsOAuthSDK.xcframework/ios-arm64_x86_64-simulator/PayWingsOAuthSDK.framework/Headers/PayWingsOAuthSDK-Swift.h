...
#ifndef PAYWINGSOAUTHSDK_SWIFT_H
#define PAYWINGSOAUTHSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PayWingsOAuthSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16PayWingsOAuthSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsOAuthSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsOAuthSDK)) <NSURLSessionWebSocketDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsOAuthSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsOAuthSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsOAuthSDK)) <NSURLSessionTaskDelegate>
